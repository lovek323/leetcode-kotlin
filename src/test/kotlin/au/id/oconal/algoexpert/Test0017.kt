...
import au.id.oconal.algoexpert.Problem0017.LinkedList
...
class Test0017 {
  ...
  companion object {
    ...
    fun dataProvider() =
      listOf(
        Data(LinkedList(1), LinkedList(1)),
        Data(
  ...
  fun test(data: Data) {
    assertEquals(data.output.toList(), Problem0017().run(data.linkedList).toList())
  }
}
