...
import au.id.oconal.general.fixedwindow.FixedWindowRateLimiterWithClientIds
...
class FixedWindowRateLimiterWithClientIdsTest {

  @Test
  fun `test rate limiting under high concurrency`() = runBlocking {
    val rateLimiter = FixedWindowRateLimiterWithClientIds(10, 1000)
